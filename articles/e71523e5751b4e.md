...
[Jest、Storybook、testing-library、MSWを活用する](#Jest、Storybook、testing-library、MSWを活用する)の節に書いたStorybookの中にある`mockGetLiftDetailsQueryMsw`や`mockSetLiftStatusMutationMsw`は、自動生成されたMSWのhandlerです。
